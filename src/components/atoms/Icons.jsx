...
export const UserCheckIcon = ({ className = "w-6 h-6" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const UserXIcon = ({ className = "w-6 h-6" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const EmployeesIcon = ({ className = "w-5 h-5" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const AttendanceIcon = ({ className = "w-5 h-5" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const RequestsIcon = ({ className = "w-5 h-5" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const SignOutIcon = ({ className = "w-4 h-4" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const DevicesIcon = ({ className = "w-5 h-5" }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
...
export const PauseIcon = ({ className = "w-4 h-4" }) => (
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M10 9v6m4-6v6m5 2a9 9 0 11-18 0 9 9 0 0118 0z"
    />
  </svg>
);
...
UserCheckIcon.propTypes = iconPropTypes;
...
SignOutIcon.propTypes = iconPropTypes;
